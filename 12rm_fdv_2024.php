...
$_SESSION['selecao'] = 1070;
$_SESSION['mfdv'] = 1;
$_SESSION['apresentacao_candidato'] = "Seleção MÉDICOS 2024";
$_SESSION['12_regiao'] = true;

$_SESSION['nome_arquivo'] = "12rm_fdv_2024.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2024<br>Farmacêuticos, Dentistas e Veterinários</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
          ...
          <form class="login-form" method="post" action="banco_dados/login.php" onsubmit="return verifica_campos()">
            <center><font size="5px"><b>SiSCanT </b></font><font size="2px"><b> FDV</b></font></center>
