...
if($_SESSION['cpf'] != '92835228004' && $_SESSION['cpf'] != '98106171787' && $_SESSION['cpf'] != '02103952065' 
    ...
    && $_SESSION['cpf'] != '52195430087' && $_SESSION['cpf'] != '70358593492')
{
    erro("Erro 34745685680! Sem permissão para download");
    exit();
}
...
$html[0] .= "<table>";
    $html[0] .= "<tr>";
        $html[0] .= "<td><b> Relatório de todos os candidatos da Seleção  $nome_selecao</b></td>";    
    $html[0] .= "</tr>";
$html[0] .= "</table>";
...
$html[0] .= "<table>";
    $html[0] .= "<tr>";
        ...
        $html[0] .= "<td><b>ETAPA</b></td>";
        $html[0] .= "<td><b>CLASSIFICADO</b></td>";
        $html[0] .= "<td><b>JUSTIFICATIVA</b></td>";
        ...
        $html[0] .= "<td><b>CIDADE EXAME MÚSCIA 12 RM</b></td>";
...
foreach($lista_candidatos as $linha)
{
    ...
    $html[$contador] .= "<table>";
        ...
        $html[$contador] .= "<td>".$linha['etapa']."</td>";
        $html[$contador] .= "<td>".$concorrendo."</td>";
        $html[$contador] .= "<td>".$linha['justificativa_concorrendo']."</td>";
        ...
        $html[$contador] .= "<td>".$linha['nome_om']."</td>";
        $html[$contador] .= "<td>".$linha['abreviatura_om']."</td>";
        ...
        $html[$contador] .= "<td>".$linha['cidade_exame_musica_12rm']."</td>";
...
$arquivo = "todos_os_candidatos_$data_.xls";
...
$insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], $_SESSION['id_usuario'], "20116", "excel_todos_candidatos", "Create", "Usuário ".$_SESSION['cpf']." gerou uma planilha excel de TODOS os candidatos ", "null");
