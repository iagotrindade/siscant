...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <form name="form_etapa_presencial" action="mpdf/relacao_inscritos_eipot_etapa_presencial_vagas_reservadas.php" method="post">
            <div class="card">
                <legend>Candidatos EIPOT - Cotas para Negros</legend>
                ...
                <div class="card-body">
                    ...
                    // $armas = ["INFANTARIA", "CAVALARIA", "ARTILHARIA", "ENGENHARIA", "INTENDÊNCIA", "COMUNICAÇÕES", "ARTILHARIA ANTIAÉREA"];
                    $armas = [];
