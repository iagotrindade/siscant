        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><b>Estado Civil: </b><?php echo $estado_civil; if($companheiro != null) echo " com $companheiro "; ?></td>
                    ...
                    <tr>
                        ...
                        if($vaga_reservada == 1) $vaga_reservada = "Sim"; echo $vaga_reservada ?></td>
                    </tr> 
                ...
                <div class="row" <?php if($_SESSION['perfil'] != 'admin') echo ' hidden ' ?>>
                    <div class="col-lg-2">
                        <a href="#especialidades"><legend>Especialidade(s) <i class="fa fa-arrow-down"></i></legend></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="#arquivos_obrigatorios"><legend>Docs Obrigatórios <i class="fa fa-arrow-down"></i></legend></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="#observacoes"><legend>Observações <i class="fa fa-arrow-down"></i></legend></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="#recursos"><legend>Recursos <i class="fa fa-arrow-down"></i></legend></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="#insere_arquivo_candidato"><legend>Arquivos <i class="fa fa-arrow-down"></i></legend></a>
                    </div>
                    <div class="col-lg-2">
                        <a href="#auditoria"><legend>Auditoria <i class="fa fa-arrow-down"></i></legend></a>
                    </div>
                </div>
            </div>
