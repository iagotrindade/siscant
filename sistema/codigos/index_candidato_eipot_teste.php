    ...
    <div class="row" >
        ...
        <div class="col-lg-6">
            <center>
                ...
                <!-- EIPOT -->
                <a <?php if($_SESSION['selecao_codigo'] === "eipot") echo " hidden "?> href="candidato_especialidade_visualiza.php" >
                ...
                <?php if ($_SESSION['selecao_codigo'] === "eipot"): ?>
                    <a href="candidato_especialidade_visualiza.php">
                        <img src="imagens/forca.jpg" width="70px">
                        <br>
                        <br>Arma e Diploma OFOR
                    </a>
                <?php endif; ?>
            </center>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="bs-component" <?php if(count($lista_inscricoes) > 0 || $_SESSION['selecao_codigo'] == "eipot") echo " hidden "?>>
            ...
            <?php if ($_SESSION['selecao_codigo'] === "eipot"): ?>
                <div class="bs-component">
                    <a class="alert-link" href="candidato_especialidade_visualiza.php">
                        <div class="alert alert-laranja">
                            <b>FALTANDO Cadastro da Arma de Formação</b> 
                        </div>
                    </a>
                </div>
            <?php endif; ?>
