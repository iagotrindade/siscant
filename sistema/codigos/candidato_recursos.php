        ...
        <div class="card">
            <div class="row">
                    ...
                    <div class="alert alert-dismissible ">
                        ...
                        <div  class="row">
                            <div class="col-lg-12">
                                <form action="../banco_dados/candidato_cadastra_recurso.php" method="post" >
                                <div  class="col-lg-2">
            ...
            echo '<div class="col-md-3">    
                <label>Status </label>
                    <select name="status_final" class="form-control">
                        <option value="">Selecione a opção</option>
                        <option '; if($linha['status_final'] == "deferido") echo " selected";  echo ' value="deferido">Deferido</option>
                        <option '; if($linha['status_final'] == "deferido_parcialmente") echo " selected";  echo '  value="deferido_parcialmente">Deferido Parcialmente</option>
                        <option '; if($linha['status_final'] == "indeferido") echo " selected";  echo '  value="indeferido">Indeferido</option>
                    </select>
            </div>
            <div class="col-md-3">    
