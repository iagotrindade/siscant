...
?>
    ...
    <div class="row"  <?php if($concorrendo == 0 ) echo " hidden "?>>
        <div class="col-lg-12">
            <div <?php if($liberacao_escolha_cidade == false || $_SESSION['candidato_etapa'] < 4 || !isset($_SESSION['eipot']) != 1) echo "hidden"  ?> class="alert alert-dismissible alert-warning">
                <a href="candidato_escolha_cidade.php"><center><b><img src="imagens/urgente.gif" height="25px"> SELECIONE A GUARNIÇÃO NA QUAL DESEJA SERVIR <img src="imagens/urgente.gif" height="25px"></b></center></a>
            </div>
        </div>
    </div>
    ...
    <div class="row" <?php if($concorrendo == 0) echo "hidden"; ?>>
        <div class="col-lg-12">
            <div <?php if($liberacao_escolha_cidade == false || $_SESSION['candidato_etapa'] < 4) echo "hidden"; ?> class="alert alert-dismissible alert-warning">
                <a href="candidato_eipot_escolha_om.php">
                    <center><b><img src="imagens/urgente.gif" height="25px"> SELECIONE A OM NA QUAL DESEJA SERVIR <img src="imagens/urgente.gif" height="25px"></b></center>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="row" >
        <div class="col-lg-12">
            <div <?php if($visualizacao_avaliacao_curricular == false || inscricao()) echo "hidden"  ?> class="alert alert-dismissible alert-warning">
                <a href="candidato_especialidade_visualiza.php"><center><b>Clique na especialidade desejada e veja a avaliação do seu currículo! <img src="imagens/urgente.gif" height="25px"></b></center></a>
            </div>
        </div>
    </div>
