...
<li class="treeview">
    <a href="#"><i class="fa fa-user"></i><span>Meu cadastro</span><i class="fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
        <li><a href="usuario_visualiza.php"><i class="fa fa-id-card-o"></i> Meu Cadastro</a></li>
        <li <?php if($_SESSION['medico_obrigatorio'] == '1') echo "hidden" ?>><a href="candidato_editar.php"><i class="fa fa-pencil"></i> Editar Cadastro</a></li>
...
<li <?php if(isset($_SESSION['eipot'])) echo " hidden " ?> class="treeview"><a href="candidato_especialidade_visualiza.php"><i class="fa fa-wrench"></i><span>Inscrição de Especialidade</span></a></li>
...
<li <?php if($_SESSION['selecao_regiao'] != 12 && $_SESSION['selecao_regiao'] != 6) echo " hidden "?>><a href="candidato_recurso.php"><i class="fa fa-file-o"></i><span>Recursos</span></a></li>

<li><a href="suporte.php"><i class="fa fa-support"></i><span>Fale conosco</span></a></li>