...
<div class="row" <?php if ($_SESSION['selecao_codigo'] != 'eipot') echo ""; ?>>
    ...
    <div class="col-md-12">
        <form action="../banco_dados/candidato_notas_eipot.php" method="post" class="card">
            <?php
            ...
            ?>
                <!-- 16 JUNHO 2025 - IAGO SILVA -->
                <div class="row">
                    <div class="col-md-12" <?php if ($_SESSION['eipot'] == 1 || $_SESSION['codigo_selecao'] == "eipot") echo " hidden " ?>>
                        <div class="card" <?php if (isset($avaliador_pode_avaliar_id_especialidade) && !$avaliador_pode_avaliar_id_especialidade) echo "style='display:none;'"; ?>>
                            <legend>Especialidade: <?php echo "<u><a href='relatorio_especialidade_candidato.php?id_especialidade=" . $valor['id_especialidade'] . "'>" . mb_strtoupper($valor['ott_stt'], "UTF-8") . " - " . $valor['especialidade'] . " - " . $valor['data_habilitacao'] . "</a></u> $texto_nao_concorrendo_especialidade<br>"; ?></legend>
                            <div class="card-body">
                                <?php
