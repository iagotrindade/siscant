<a name='eipot'></a>
<div class="row" <?php if($_SESSION['selecao_codigo'] != 'eipot') echo "  " ?>>
    <div class="col-md-12">
        <div class="card">
            <div class="row">
    ...
    <div class="card"  <?php if(isset($avaliador_pode_avaliar_id_especialidade) && !$avaliador_pode_avaliar_id_especialidade) echo "hidden" ?>>          
            <legend>Especialidade: <?php echo " <u><a href='relatorio_especialidade_candidato.php?id_especialidade=".$valor['id_especialidade']."'>" . mb_strtoupper($valor['ott_stt'], "UTF-8") . " - " .$valor['especialidade'] . " - ". $valor['data_habilitacao']."</a></u> $texto_nao_concorrendo_especialidade<br>"; ?></u></legend>
            <div class="card-body ">
                    ...
                    <thead>
                      <tr>
                            ...
                            if($id_especialidade != null)
                            {
                                ...
                                foreach ($lista_curriculo_adicionado as $linha) 
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="multiplicador" '; if($linha['multiplicacao'] != '1') echo ' disabled  >';
                                                for($i=0; $i <= $linha['quantidade_multiplicacao']; $i++)
                                                {
                                                    echo '<option'; if($linha['multiplicador'] == $i) echo " selected "; echo' value="'.$i.'"> '.$i.' </option>';
                                                }
                                                echo '
                                            </select>
                                        </td>
                        ...
                        <div  class="row">
                            ...
                            <div  class="col-lg-3">
                                <div class="form-group"> <label>Flexão de braço</label>
                                    <select name="qtd_flexao_braco" class="form-control">
                                        <option value="">Selecione a quantidade</option>
                                        <?php
                                            for($i = 1; $i <= 50 ; $i++)
                                            {
                                                if($qtd_flexao_braco == $i)
                            ...
                            <div  class="col-lg-3">
                                <div class="form-group"> <label>Abdominal Supra</label>
                            ...
                            <div  class="col-lg-3">
                                <div class="form-group"> <label>Flexão na Barra Fixa</label>
                            ...
                            <div  class="col-lg-3">
                             ...
                             <div  class="col-lg-3">
                                <div  class="form-group"> 
                                    ...
                                    <input value="<?php     
                                            if ($nota_ofor_avaliador != '') echo $nota_ofor_avaliador?>" 
                                    name="notafinal_ofor" class="form-control">
                                </div>
                            </div>
                            
                             <div  class="col-lg-3">
                                <div class="form-group"> <label>Ano da turma de formação OFOR </label>
                                    <select name="nota_ano_formacao" class="form-control">
                                        <option value="">Selecione a opção</option>
                                        <?php
                                            for($i = date(Y); $i >= date(Y)-22 ; $i--)
                                            {
                                                if($ano_formacao_ofor_avaliador == $i)
                                                    echo "<option selected value='$i'>$i</option>";
                                                else
                                                    echo "<option value='$i'>$i</option>";
                                            }
                            ...
                            <div  class="col-lg-3">
                                <label><br><font size="5px">Nota final: <?php echo $nota_final_eipot; ?></font></label>
                            </div>
                            <div  class="col-lg-3" <?php if($foto_usuario_avaliou_eipot == null) echo " hidden "; ?>>
                                <label><br><font size="2px">Avaliado por: <?php echo $foto_usuario_avaliou_eipot; ?></font></label>
                                <label><br><font size="2px">em: <?php echo $eipot_data_avaliacao; ?></font></label>
                            </div>
