...
?>
    ...
    <div class="card" <?php if($_SESSION['selecao_codigo'] == 'eipot') echo " hidden "; ?> >
            ...
            <div class="row" <?php if($_SESSION['selecao_regiao'] != 3) echo ' hidden ' ?>>
                ...
                <div class="col-md-4">
                    <br>
                    <p id='diferenca_datas'><b><legend>Diferença em Meses: </legend></b></p>
                </div>
                </form>
            </div>
            ...
            <div class="row" <?php if($_SESSION['selecao_regiao'] == 3) echo ' hidden ' ?>>
                ...
                <div class="col-md-4">
                    <br>
                    <p id='diferenca_datas_dias'><b><legend>Diferença em dias: </legend></b></p>
                </div>
                </form>
            </div>
...
<div class="row">
    ...
    <?php
        ...
        <div class="card"  <?php if(isset($avaliador_pode_avaliar_id_especialidade) && !$avaliador_pode_avaliar_id_especialidade) echo "hidden" ?>>          
            <legend>Especialidade: <?php echo " <u><a href='relatorio_especialidade_candidato.php?id_especialidade=".$valor['id_especialidade']."'>" . mb_strtoupper($valor['ott_stt'], "UTF-8") . " - " .$valor['especialidade'] . "</a></u> $texto_nao_concorrendo_especialidade<br>"; ?></u></legend>
            <div class="card-body ">
            ...
            <table border = '1' style="width: 100%">
                <tbody>
                <tr>
                    <td ><b>SOMATÓRIO DOS PONTOS VÁLIDOS</b></td>
                    <td ><b> 
                        <?php 
                            if($valor['musica'] )
            ...
            <div class="row" 
                ...
                <br>
                <div class="col-md-12">
                    <div <?php // echo " hidden " ?> class="alert alert-info">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group"> 
                                    <label><font color="red"> *Máximo 5 MegaBytes no formato PDF</font></label>
            ...
            <div <?php if($_SESSION['perfil'] != "admin" && $_SESSION['perfil'] != "avaliador") echo " hidden " ?> class="alert alert-info">
                <legend>Concorrendo/Não concorrendo na especialidade <?php echo mb_strtoupper($valor['ott_stt'], "UTF-8") . " - " .$valor['especialidade'] ?></legend>
                    <div class="row">
                        ...
                        <div class="col-md-6" <?php if($etapa < 4 || !$concorrendo_especialidade) echo " hidden " ?>>
