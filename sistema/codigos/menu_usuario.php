...
<li <?php if ($perfil == "ouvidor" || $perfil == "avaliador" || $perfil == "documentos" || $perfil == "om") echo "hidden"; ?> class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li <?php if (!isset($_SESSION['eipot']) || $perfil == "chc" || $perfil == "cr") echo "hidden" ?> class="treeview"><a href="eipot_etapa_III.php"><i class="fa fa-stethoscope"></i><?php if ($_SESSION['perfil'] == "jise") echo ('JISE');
                                                                                                                                                                                            else echo ('Dados Cadastro IS - SIPMED') ?></a>

        <li <?php if (isset($_SESSION['eipot']) || $perfil == "chc" || $perfil == "cr") echo "hidden" ?> class="treeview"><a href="relatorio_etapa_III.php"><i class="fa fa-stethoscope"></i><?php if ($_SESSION['perfil'] == "jise") echo ('JISE');
                                                                                                                                                                                            else echo ('Inspeção de Saúde') ?></a>
