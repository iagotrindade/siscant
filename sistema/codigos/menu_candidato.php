...
<li ><a href="candidato_recurso.php"><i class="fa fa-file-o"></i><span>Recursos</span></a></li>
<li <?php if($_SESSION['selecao_regiao'] == 7) echo "hidden" ?> ><a href="suporte.php"><i class="fa fa-support"></i><span>Fale conosco</span></a></li>