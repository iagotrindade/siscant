    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card" <?php if ($concorrendo_esp != 0) echo "hidden"  ?>>
                <legend>
                    <font color='red'><?php echo " DESCLASSIFICADO! Justificativa: " . $justificativa_con; ?> </font>
                </legend>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <p>
                                            <font color="red"><b>Atenção!</b></font> Os arquivos de diplomas devem conter frente e verso!
                                        </p>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <legend>
                            <font color="red">Atenção!</font> Lembre-se do Diploma (pré-requisito) e do Registro do Conselho Profissional se for o caso
                        </legend>
                        <div class="card-body">
