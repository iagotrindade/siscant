...
$arquivo = "medicos_obrigatorios_reduzida_$data_.xls";
...
$insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], $_SESSION['id_usuario'], "20112", "excel_medicos_obrigatorios_reduzida", "Create", "Usuário ".$_SESSION['cpf']." gerou uma planilha excel de TODOS os médicos obrigatórios - Planilha Reduzida ", null);
