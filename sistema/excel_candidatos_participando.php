...
foreach($lista_candidatos as $linha)
{
    ...
    $html[$contador] .= "<table>";
		...
		$html[$contador] .= "<td>_".$linha['arma_eipot']."</td>";
...
$insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], $_SESSION['id_usuario'], "20115", "excel_todos_candidatos", "Create", "Usuário ".$_SESSION['cpf']." gerou uma planilha excel dos candidatos participando", "null");
