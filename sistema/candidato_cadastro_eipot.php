<?php
    ...
    include_once './codigos/candidato_campos_cadastra_eipot.php';
    include_once './codigos/candidato_valida_cadastro_eipot.php';
...
<div class="row">
  <div class="col-md-12">
      <form action="../banco_dados/candidato_cadastra_eipot.php" method="post" onsubmit="return candidato_valida_cadastro()" >
                ...
                <div  class="col-lg-4">
                    <div class="form-group"> <label>Sexo</label>
                        <select id="sexo" name="sexo" class="form-control" onchange="select_sexo()">
                            ...
                            <option <?php if (isset($_SESSION['eipot'])) echo " hidden "?>value="feminino">Feminino</option>
                        </select>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            const divCompanheiro = document.getElementById('div_companheiro');
                            
                            // Função que mostra ou esconde o campo de companheiro(a)
                            function mostraCompanheiro() {
                                const estadoCivil = estadoCivilSelect.value;
                                
                                if (estadoCivil === 'uniao_estavel' || estadoCivil === 'casado') {
                                    divCompanheiro.hidden = false;
                                } else {
                                    divCompanheiro.hidden = true;
                                }
                            }

                            // Adicionando o evento change
                            estadoCivilSelect.addEventListener('change', mostraCompanheiro);
                        });
                    </script>
                    ...
                    <script>
                        function mostra_vaga_reservada() {
                            if ($('#autodeclaracao').val() == 'preto' || $('#autodeclaracao').val() == 'pardo') {
                                ...
                                $('#div_vaga_reservada').hide();
                                // Desmarcar o checkbox caso o div seja escondido
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="checkboxes" class="mt-2">
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="1" onchange="updateSelectedOptions(this)"> 1ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="2" onchange="updateSelectedOptions(this)"> 2ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="3" onchange="updateSelectedOptions(this)"> 3ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="4" onchange="updateSelectedOptions(this)"> 4ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="5" onchange="updateSelectedOptions(this)"> 5ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="6" onchange="updateSelectedOptions(this)"> 6ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="7" onchange="updateSelectedOptions(this)"> 7ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="8" onchange="updateSelectedOptions(this)"> 8ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="9" onchange="updateSelectedOptions(this)"> 9ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="10" onchange="updateSelectedOptions(this)"> 10ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="11" onchange="updateSelectedOptions(this)"> 11ª Região Militar</label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label"><input type="checkbox" class="form-check-input" value="12" onchange="updateSelectedOptions(this)"> 12ª Região Militar</label>
                    </div>
                </div>
                ...
                <textarea id="rm_destino" class="form-control mt-3" rows="3" readonly placeholder="Opções selecionadas aparecerão aqui..."></textarea>
                  <!-- Campo oculto para armazenar o array -->
            ...
            <script>
                    ...
                    function updateSelectedOptions(checkbox) {
                        ...
                        if (checkbox.checked) {
                            // Adiciona a opção na ordem que foi selecionada
                            selectedOptionsArray.push(checkbox.value);
                          //  selectedOptionsArray.push(checkbox.nextSibling.textContent.trim());
                        } else {
                        ...
                        // Atualiza a caixa de texto com as opções selecionadas
                        textarea.value = selectedOptionsArray.join(', ');
                        hiddenInput.value = selectedOptionsArray.join(',');
                    }

                    // Função para acessar o array fora do escopo da função
                ...
                <div  class="col-lg-6">
                    <div id="rm_inscricao" class="form-group"> 
                        ...
                        <select name="rm_inscricao" class="form-control">
                            ...
                            <option value="1">1ª RM - Rio de Janeiro (RJ)</option>
                            <option value="2">2ª RM - São Paulo (SP)</option>
                            <option value="3">3ª RM - Porto Alegre (RS)</option>
                            <option value="4">4ª RM - Belo Horizonte (MG)</option>
                            <option value="5">5ª RM - Curitiba (PR)</option>
                            <option value="6">6ª RM - Salvador (BA)</option>
                            <option value="7">7ª RM - Recife (PE)</option>
                            <option value="8">8ª RM - Belém (PA)</option>
                            <option value="9">9ª RM - Campo Grande (MS)</option>
                            <option value="10">10ª RM - Fortaleza (CE)</option>
                            <option value="11">11ª RM - Brasília (DF)</option>
                            <option value="12">12ª RM - Manaus (AM)</option>
                        </select>
                    </div>
                </div>
            ...
            <div  class="row">
                ...
                <div  class="col-lg-6">
                    <div  class="form-group"> <label>Nome do curso de graduação </label> 
                        <font color="red"> *Deve ter concluído o curso e colado grau até a Incorporação (1º Set 25)</font>
                ...
                <div  class="col-lg-6">
                    <div class="form-group"> 
                        <label>Ano de formação do CPOR ou NPOR (OFOR)</label> <font color="red"> * Ano com 4 dígitos | Exemplo: 2019</font>
               ...
               <!-- <div class="col-lg-6">
                    <div class="form-group"> 
                        <label>Nota de conclusão do CPOR/NPOR (OFOR) </label> <font color="red"> * Exemplo: 07.60</font>
...
<div class="row">
    <div class="col-md-12">
        <div class="">
            <legend>Civil ou Militar Temporário das Forças Armadas</legend> 
            <div class="row">
                
                <div class="col-lg-3">
                    <div id="div_civil_militar" class="form-group"> 
                        <label>Você é civil ou militar temporário?</label>
                        <select id="civil_militar" name="civil_militar" class="form-control">
                            <option value="">Selecione a opção</option>
                ...
                <div class="col-lg-3" hidden id="div_ja_foi_militar">
                    <div class="form-group"> 
                        <label>Já foi Militar?</label>
                        <select id="ja_foi_militar" name="ja_foi_militar" class="form-control">
                            <option value="">Selecione a opção</option>
