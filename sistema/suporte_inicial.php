...
?>
      ...
      <div class="content-wrapper">
        <div class="card">
            <div class="row">
                <div class="col-md-6">
                    <legend><b>Suporte</b> <i class="fa fa-support"></i> <small class="pull-right">...</small> </legend>
                ...
                <div class="col-md-6">
                    ...
                    <p>Preencha os campos para solicitar um suporte a administração do sistema</p>
                </div>
