...
if ($sexo == 'masculino') {
    $select_posto_grad .= '<option ';
    if ($posto_grad == 'sd') $select_posto_grad .= ' selected ';
    $select_posto_grad .= 'value="sd">Soldado</option>';
}

$select_posto_grad .= '<option ';
if ($posto_grad == 'cb') $select_posto_grad .= ' selected ';
$select_posto_grad .= 'value="cb">Cabo</option>

    <option ';
if ($posto_grad == '3_sgt') $select_posto_grad .= ' selected ';
$select_posto_grad .= 'value="3_sgt">3º Sargento</option>

    <option ';
if ($posto_grad == 'asp') $select_posto_grad .= ' selected ';
$select_posto_grad .= 'value="asp">Aspirante</option>

    <option ';
if ($posto_grad == '2_ten') $select_posto_grad .= ' selected ';
$select_posto_grad .= 'value="2_ten">2º Tenente</option>

    <option ';
if ($posto_grad == '1_Ten') $select_posto_grad .= ' selected ';
...
if ($certificado == 'cdi') {
    $select_certificado = ' 
            ...
            <option';
    if ($certificado == 'cdi') $select_certificado .= ' selected ';
    $select_certificado .= ' value="cdi">Certificado de Dispensa de Incorporação (CDI)</option>

            <option ';
    if ($certificado == 'ci') $select_certificado .= ' selected ';
...
?>
<form action="../banco_dados/candidato_edita.php" method="post" onsubmit="return candidato_valida_cadastro()">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="animated-checkbox form-group">
                                                        <label>
                                                            <input type="checkbox" id="check_nome_social" <?php if ($nome_social != null) echo "checked" ?> name="check_nome_social" onchange="mostra_nome_social()">
                                                            <span class="label-text">Possuo nome social</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div id="div_nome_social" <?php if ($nome_social == null) echo "hidden" ?> class="form-group">
...
-->
                        ...
                        <div class="row" <?php if (!isset($_SESSION['eipot'])) echo " hidden " ?>>
                            ...
                            <option <?php if ($arma_eipot == 'Infantaria') echo 'selected' ?> value=" Infantaria">Infantaria (INF)</option>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Ano de formação do OFOR</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input maxlength="50" value="<?php if ($nota_ofor != null) echo $nota_ofor ?>" name="nota_ofor" class="form-control">
                                            </div>
                                        </div>
