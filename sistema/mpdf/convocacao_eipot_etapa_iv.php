...
$titulo_etapa_iv = $_POST['titulo_etapa_iv'];
$subtitulo_etapa_iv = $_POST['subtitulo_etapa_iv'];
$paragrafo_um_convocacao_iv = $_POST['paragrafo_um_convocacao_iv'];
$paragrafo_dois_convocacao_iv = $_POST['paragrafo_dois_convocacao_iv'];
$paragrafo_tres_convocacao_iv = $_POST['paragrafo_tres_convocacao_iv'];
$paragrafo_quatro_convocacao_iv = $_POST['paragrafo_quatro_convocacao_iv'];
...
<p style='font-size: 12px; text-align: justify; margin: 5px 0; text-indent: 2em;'>$paragrafo_um_convocacao_iv</p>

<p style='font-size: 12px; text-align: justify; margin: 5px 0; text-indent: 2em;'>$paragrafo_dois_convocacao_iv</p>

<p style='font-size: 12px; text-align: justify; margin: 5px 0; text-indent: 2em;'>$paragrafo_tres_convocacao_iv</p>

<p style='font-size: 12px; text-align: justify; margin: 5px 0; text-indent: 2em;'>$paragrafo_quatro_convocacao_iv</p>
...
foreach ($inscritos_por_arma as $arma => $candidatos) {
   ...
   <table border='1' style='width:100%; border-collapse: collapse; margin-bottom: 20px;'>
    ...
    foreach ($candidatos as $candidato) {
        if($candidato['apto_saude'] != 1 && $candidato['apto_saude_recurso'] != 1) {
            continue;
        }
