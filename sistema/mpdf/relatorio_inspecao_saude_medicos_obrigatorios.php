...
$html = $html. "
 ...
 <table border='0' style='width:100%'>
  <tr>
    <th align='center'><strong> <p style='font-size: 12px; font-family: Times New Roman;'>JISE:  Sessão Nº $sessao - CSE - Médicos Obrigatórios de ".$_POST['data_inspecao']." na cidade de  $cidade. </p></strong></th>
  </tr>
</table> 

" ;

$lista_candidatos_ = $conexao->get_ata_dia_exame_medico_para_medicos_obrigatorios($data_ata); 
    ...
    $html = $html . "
        <tr>
            ...
            <td>
             ...
             <td>
                ".mb_strtoupper($candidato['grupo_saude'])."
            </td>
            <td>
                ".$candidato['cid_saude']."
            </td>
...
$insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], null, "20117", "relatorio", "create", "Gerou um relatório de quem realizou exame de saúde de médico obrigatório na data de $data_inspecao_saude", $alteracoes_detalhadas);
