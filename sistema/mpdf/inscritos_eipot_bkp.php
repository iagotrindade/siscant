...
$lista_inscritos = $conexao->get_inscritos_eipot(); 
foreach ($lista_inscritos as &$inscritos) 
{
    $html = "";
    $html = $html . "
        ...
        <tr style='background-color: #D8D8D8'>
            <td colspan=\"3\"> <center><b> ".mb_strtoupper($inscritos['_completo'],"UTF-8")."</b></center></td>
        </tr>
        <tr style='background-color: #D8D8D8'>
            <td> </td>
        </tr>";
    
        $lista_candidatos_inscritos = $conexao->get_inscritos_eipot();  
        $contador = 1;

        if(count($lista_candidatos_inscritos) == 0)
        {
            $html = $html . "
            <tr>
                <td colspan='3'>
                    Nenhum candidato se inscreveu para esta inscritos.
                </td>
            </tr>";
        }
        else
        {
            ...
            foreach($lista_candidatos_inscritos as &$candidato)
            {
