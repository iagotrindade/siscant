    ...
    $html .= "
            ...
            <table border='1' style='width:100%; border-collapse: collapse; margin-bottom: 20px;'>
                <tr style='text-align: center; background-color: #D8D8D8; font-size: 14px;'>
                    ...
                    <th style='text-align: center; width: 35%;'>NOME</th>
                    <th style='text-align: center; width: 45%;'>ASSINATURA</th>
                </tr>
        ";
...
$mpdf->Output("Lista de Presença Etapa IV - Teste de Aptidão Física (EAF).pdf", 'D');
ob_end_flush();
exit();
