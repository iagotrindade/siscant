...
// Cabeçalhos por RM
$cabecalhos = [
    '3'  => "MINISTÉRIO DA DEFESA<br>EXÉRCITO BRASILEIRO<br>COMANDO MILITAR DO SUL<br>(Gov das Armas Prov do RS/1821)<br>REGIÃO DOM DIOGO DE SOUZA<br>",
...
foreach ($lista_candidatos_recurso as $candidato) {
    ...
    if ($candidato['id_selecao'] != $_SESSION['selecao'] || $candidato['obs_etapa'] != '3 - Documental') {
        continue;
    }
