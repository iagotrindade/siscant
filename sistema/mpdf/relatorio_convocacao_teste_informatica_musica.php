...
if (empty($especialidadesSelecionadas)) {
    erro_gerar_relatorio_cadastro_candidato("Erro 3541621441 nenhuma especialidade selecionada!");
    exit();
}
...
foreach ($especialidadeInformatica as $especialidade => $candidatos) {
    ...
    <table border='1' style='width:100%; border-collapse: collapse; margin-bottom: 20px;'>
        <tr>
            <th colspan='3' style='text-align: center; background-color: #D8D8D8; font-size: 12px;'>" . mb_strtoupper($especialidade, "UTF-8") . "</th>
        </tr>
        <tr style='text-align: center; background-color: #D8D8D8; font-size: 12px;'>
            <th style='font-size: 12px; text-align: center; width: 5%;'>Nº</th>
            <th style='font-size: 12px; text-align: center; width: 25%;'>CPF</th>
