...
$insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], null, "20102", "relatorio", "create", "Gerou um relatório de classificação em $datetime", $alteracoes_detalhadas);

if($insere_log)
    $mpdf->Output("relatorio_personalizado.pdf",'D');
