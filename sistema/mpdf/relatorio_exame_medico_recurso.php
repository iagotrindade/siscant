...
$apto_saude = $candidato_relatorio[0]['apto_saude_recurso'];
...
$cid_saude = $candidato_relatorio[0]['cid_saude_recurso'];
$obs_saude = $candidato_relatorio[0]['observacao_exame_saude_recurso'];
...
$insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], null, "20111", "relatorio", "create", "Gerou um relatório de RECURSO exame médico do candidato CPF $cpf de ID $id_candidato", null);
