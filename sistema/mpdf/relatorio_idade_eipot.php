...
<table border='0' style='width:100%; margin-top: 5px; margin-bottom: 5px;'>
    <tr>
        <th align='center'><strong>RELATÓRIO DE IDADES - POR ARMA</strong></th>
    </tr>
</table>
...
// Agrupa inscritos por arma filtrando aqueles cujo rm_inscricao é igual a 3
...
foreach ($inscritos_por_arma as $arma => $candidatos) {
   ...
   <table border='1' style='width:100%; border-collapse: collapse; margin-bottom: 20px;'>
    ...
    <tr>
        ...
        <th style='text-align: center; width: 60%;'>IDADE</th>
    </tr>
    ";

    if (!function_exists('get_idade')) {
        function get_idade($data_nascimento) {
    ...
    usort($candidatos, function($a, $b) {
        $idadeA = get_idade($a['data_nascimento']);
        $idadeB = get_idade($b['data_nascimento']);
        return $idadeB - $idadeA; // Ordenação decrescente 
    });
    ...
    foreach ($candidatos as $candidato) {
        ...
        $idade = get_idade($candidato['data_nascimento']);
