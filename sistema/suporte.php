                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div id="div_mail" class="form-group">
                                <label> <img height="40px" src="imagens/urgente.gif">
                                    <font color="red">Certifique-se que sua dúvida não se encontre na página de <a href="duvidas_frequentes.php">DÚVIDAS FREQUENTES</a></font><img height="40px" src="imagens/urgente.gif">
                                </label>
