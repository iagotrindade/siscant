...
<table border='0' style='width:100%; margin-top: 5px; margin-bottom: 5px;'>
    <tr>
        <th align='center'><strong>" . mb_strtoupper("Estágio de Instrução e de Preparação para Oficiais Temporários (EIPOT) / 2025", "UTF-8") . "</strong></th>
    </tr>
</table>

<table border='0' style='width:100%; margin-top: 5px; margin-bottom: 5px;'>
    <tr>
        <th align='center'><strong>Relatório de candidatos inscritos - Classificação Vagas Reservadas</strong></th>
    </tr>
</table>

<p style='font-size: 12px; font-family: Times New Roman; text-align: justify; margin: 5px 0;'>
    O Comandante da " . $rm_usuario ."ª Região Militar divulga a relação da Classificação dos candidatos concorrendo para o Estágio de Instrução e de Preparação para Oficiais Temporários,
    conforme anexo \"A\" (Calendário de Eventos) do Aviso de Convocação.
</p>

<p style='font-size: 12px; font-family: Times New Roman; text-align: justify; margin: 5px 0;'>
    A presente relação está em ordem classificatória, por Arma de Formação.
    <br>
    <br>
</p>
";
...
foreach ($inscritos_por_arma as $arma => $candidatos) {
   ...
   <table border='1' style='width:100%; border-collapse: collapse; margin-bottom: 20px;'>
    ...
    <tr>
        ...
        <th style='text-align: center; width: 60%;'>PONTUAÇÃO</th>
    </tr>
    ";
    ...
    foreach ($candidatos as $candidato) {
        ...
        <tr>
            ...
            <td style='text-align: left;'>" . $candidato['nome_completo'] . "</td>
            <td style='text-align: center;'>" . $nota_final_eipot[$index] . "</td>
        </tr>";
        $contador++;
