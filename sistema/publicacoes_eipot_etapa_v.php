...
<div class="content-wrapper">
    ...
    <form name="form_etapa_presencial" action="mpdf/convocacao_eipot_etapa_iv.php" method="post">
        <div class="card">
            <h3>Convocação para Etapa V - Heteroidentificação</h3> <br><!-- Título do formulário -->
            ...
            <div style="float: left; width: 48%;">
                <div class="form-group">
                    ...
                    <input type="text" name="subtitulo_etapa_v" class="form-control" value="Convocação para Etapa V - Heteroidentificação - Xª RM" required>
                </div>
            </div>

            <div class="form-group">
                <label for="paragrafo_um_convocacao_iv">Primeiro Parágrafo:</label>
                <input type="text" name="paragrafo_um_convocacao_v" class="form-control" value="O Comandante da Xª RM, de acordo com o Aviso de Convocação Nr X-SSMR/X, de 10 de março de 2025, divulga a chamada dos candidatos selecionados para a Etapa V – HETEROIDENTIFICAÇÃO." required>
            </div>

            <div class="form-group">
                <label for="paragrafo_dois_convocacao_iv">Segundo Parágrafo:</label>
                <input type="text" name="paragrafo_dois_convocacao_v" class="form-control" value="Informo que será ELIMINADO o candidato CONVOCADO que NÃO COMPARECER à Etapa V." required>
            </div>
            ...
            <button type="submit" class="btn btn-primary btn-block mb-20">PUBLICAÇÃO CONVOCAÇÃO PARA ETAPA V - HETEROIDENTIFICAÇÃO </button>

            <a href="mpdf/relatorio_lista_presenca_eipot_etapa_iv.php" type="submit" class="btn btn-primary btn-block">LISTA DE PRESENÇA ETAPA V - HETEROIDENTIFICAÇÃO</a>
        </div>
        <br>
    </form>
    ...
    <form name="form_relacao_classificacao_eipot_pontuacao" action="mpdf/resultado_eipot_etapa_v.php" method="post">
        <div class="card">
            <h3>Resultado Etapa V - Heteroidentificação</h3><br> <!-- Título do formulário -->
            ...
            <div style="float: left; width: 48%;">
                <div class="form-group">
                    <label for="titulo_um">Subtítulo:</label>
                    <input type="text" name="subtitulo_resultado_etapa_v" class="form-control" value="Resultado Etapa V - Heteroidentificação - Xª RM" required>
                </div>
            </div>

            <div class="form-group">
                <label for="paragrafo_um_resultado_iv">Primeiro Parágrafo:</label>
                <input type="text" name="paragrafo_um_resultado_v" class="form-control" value="O Comandante da Xª RM, de acordo com o Aviso de Convocação Nr X-SSMR/X, de 10 de março de 2025, divulga o resultado da Etapa V - HETEROIDENTIFICAÇÃO." required>
            </div>
            ...
            <div class="col-mg-12">
                <button type="submit" class="btn btn-primary btn-block">PUBLICAÇÃO RESULTADO INICIAL ETAPA V - HETEROIDENTIFICAÇÃO</button>
            </div>
        </div>
    </form>
    ...
    <form name="form_relacao_classificacao_eipot_pontuacao" action="mpdf/resultado_eipot_etapa_v.php" method="post">
        <div class="card">
            <h3>Resultado Etapa V - Heteroidentificação em Grau de Recurso</h3><br> <!-- Título do formulário -->
            ...
            <div style="float: left; width: 48%;">
                <div class="form-group">
                    <label for="titulo_um">Subtítulo:</label>
                    <input type="text" name="subtitulo_resultado_recurso_etapa_v" class="form-control" value="Resultado Etapa V - Heteroidentificação em Grau de Recurso - Xª RM" required>
                </div>
            </div>

            <div class="form-group">
                <label for="paragrafo_um_resultado_iv">Primeiro Parágrafo:</label>
                <input type="text" name="paragrafo_um_resultado_recurso_v" class="form-control" value="O Comandante da Xª RM, de acordo com o Aviso de Convocação Nr X-SSMR/X, de 10 de março de 2025, divulga o resultado da Etapa V - Heteroidentificação em Grau de Recurso." required>
            </div>
