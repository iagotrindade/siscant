                            ...
                            <div class="alert alert-success d-flex flex-column justify-content-center align-items-center">
                                <div style='width: 100px;'>
                                    <div style='display: inline-block; padding: 4px; background: white; border-radius: 8px;'>
                                        <img src='../fotos/$foto' height='120px' style='border-radius: 4px; display: block; border: 2px solid #006400; width: 100px;'>
                                    </div>
                                </div>

                                <div class="d-flex flex-column justify-content-center align-items-center">
                                    <div style='font-size: 13px; font-weight: 600; margin-bottom: 8px; color: #2d5016;'>
                                        <span style='font-weight: 700; color: #006400;'><?= mb_strtoupper($candidato_escolhendo[0]['nome_completo']) ?></span>
                                    </div>

                                    <div style='font-size: 13px; font-weight: 600; margin-bottom: 8px; color: #2d5016;'>
                                        CPF: <span style='font-weight: 700; color: #006400;'><?= mascara($candidato_escolhendo[0]['cpf'], '###.###.###-##') ?></span>
                                    </div>
