    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if ($id_especialidade_selecionada != 0) {
                ...
                if (count($get_especialidade_selecionada) > 0 && ($_SESSION['perfil'] == 'admin' || $_SESSION['perfil'] == 'consulta')) {
                    if ($get_especialidade_selecionada[0]['musica'] != 1 && $get_especialidade_selecionada[0]['ott_stt'] != 'cet')
            ...
            <div class="card">
                <legend>
                    <font color="red">Candidatos desclassificados da especialidade com justificativa</font>
                </legend>
                <div class="card-body">
