                            ...
                            <?php else : ?>
                                <div class="inscricoes-grid">
                                    <?php foreach ($lista_inscricoes as $value) : ?>
                                        <?php
                                        if ($value['escolhe_guarnicao'] == 0 && $value['id_candidato_escolhendo_guarnicao'] != $_SESSION['id_usuario']) continue;
                                            ...
                                            <div class="card-body">
                                                ...
                                                <?php if ($value['concorrendo'] == 1 && $value['cidade_escolheu_servir'] == null && $tem_vaga_ && $pode_selecionar) : ?>
                                                    ...
                                                    <div class="selecao-guarnicao border-top pt-4 mt-3" id="form-container-<?= $value['id_especialidade'] ?>">
                                                        <form action="../banco_dados/candidato_cidade_escolheu_servir_admin.php" method="post" id="form-escolha-<?= $value['id_especialidade'] ?>">
                                                            <div class="row mb-20">
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select id="cidade_escolheu" name="cidade_escolheu_servir" class="form-control">
                                                            ...
                                                            <div class="alert alert-success alert-vez-container">
                                                                <h4 class="alert-heading"><i class="fa fa-check-circle me-2"></i> Escolha sua Guarnição!</h4>
                                                                <p>É sua vez de escolher! Você pode selecionar uma guarnição</p>
                                                            </div>
