...
if ($get_suporte_id != null) {
    ...
    $resposta_atual = $get_suporte_id[0]['resposta'];
                    ...
                    <div class="support-request">
                        <div class="user-info-section">
                            <div class="user-avatar">
                                <img src="./imagens/user.jpg" alt="<?php echo $nome_candidato ?>" class="user-image">
                            </div>
            ...
            <div class="card-modern">
                ...
                <div class="card-body-modern">
                    ...
                    <div class="chat-container" id="chatContainerSupport">
                        <?php
                        $lista_suporte = $conexao->get_suporte_candidato_nao_inscrito($cpf);
                        ?>
                    ...
                    <form action="../banco_dados/suporte_inicial_resposta.php" method="POST" id="suporte">
