                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div id="mensagem_erro">
                                        <font color="red"><b>
                                                <center>
                                                    <p id="mensagem"> Atenção! A atualização das cidades apaga a quantidade de vagas já cadastradas</p>
                                                </center>
                                            </b></font>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <form action="../banco_dados/quantidade_vagas_cidade_atualiza.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <!-- 11/07/2025 -> Iago Silva Inseridno o campo Região Militar -->
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Região Militar</label><br>
                                        <select name="regiao_militar" class="form-control">
                                            <?php
                                            for ($i = 1; $i <= 12; $i++) {
