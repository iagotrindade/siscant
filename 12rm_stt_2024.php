...
$_SESSION['selecao'] = 1072;
$_SESSION['12_regiao'] = true;

$_SESSION['apresentacao_candidato'] = "Seleção STT 2024";
$_SESSION['nome_arquivo'] = "12rm_stt_2_2024.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos à Temporários<br> SELEÇÃO 2024<br>STT <br>(Sargento Técnico Temporário)</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
