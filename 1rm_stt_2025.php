...
$_SESSION['nome_arquivo'] = "1rm_stt_2025.php";
// A seleção é referente ao index da tabela do banco de dados SELEÇÃO
$_SESSION['selecao'] = 1134;

$_SESSION['apresentacao_candidato'] = "Seleção de Sargento Técnico Temporário ";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        <img src="sistema/imagens/1rm.png" width="80px">
        <center>
        <font color="white">
            <b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO STT 2025
            <br><u>Seleção de Sargentos Técnicos Temporários</u>
            </b>
        </font>
        </center>
      <div class="logo">
