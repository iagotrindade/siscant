...
$rand = rand(100, 10000);
$string = "selecao_ott_stt_2025_3";
$codigo_criptografar = $rand . time() . $string;
$codigo_chave = substr(md5($codigo_criptografar), 0, 6);
$_SESSION['chave'] = $codigo_chave;

$_SESSION['nome_arquivo'] = "3rm_ott_stt_2025_3.php";
// A seleção é referente ao index da tabela do banco de dados SELEÇÃO
$_SESSION['selecao'] = 1186;
$_SESSION['tipo_selecao'] = 'ott_stt'; // minas e biblioteca

$_SESSION['apresentacao_candidato'] = "Seleção Sargentos Técnicos Temporários - STT Cozinha";
...
<body>
  ...
  <div class="login-card">
    <div class="text-center">
      ...
      <p class="text-muted">Seleção 2025/2026 - STT Cozinha</p>
    </div>
