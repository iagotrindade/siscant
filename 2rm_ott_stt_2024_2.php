...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white">
            <b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO OTT/STT 2024
