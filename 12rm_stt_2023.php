...
$_SESSION['selecao'] = 1006;
$_SESSION['12_regiao'] = true;

$_SESSION['apresentacao_candidato'] = "Seleção STT 2023";
$_SESSION['nome_arquivo'] = "12rm_stt_2023.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos à Temporários<br> SELEÇÃO 2022/2023<br>STT <br>(Sargento Técnico Temporário)</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
