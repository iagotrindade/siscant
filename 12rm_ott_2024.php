...
$_SESSION['selecao'] = 1071;
$_SESSION['12_regiao'] = true;

$_SESSION['apresentacao_candidato'] = "Seleção OTT 2024";
$_SESSION['nome_arquivo'] = "12rm_ott_2024.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos à Temporários<br> SELEÇÃO 2024<br>OTT <br>(Oficial Técnico Temporário)</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
