...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white">
            <b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2023
            <br>OTT/STT
            <br><u>Oficial e Sargento Técnico Temporário</u>
            </b>
        </font>
        </center>
      <div class="logo">
