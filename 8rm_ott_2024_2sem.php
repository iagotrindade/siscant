...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white">
            <b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2024
            <br>OTT
            <br><u>Oficial Técnico Temporário</u>
            </b>
        </font>
        </center>
      <div class="logo">
      ...
      <div class="login-box">
        ...
        <div class="form-group">
            <br><center><font size="5px"><b><a class="btn btn-warning" href="8rm.php">PÁGINA INICIAL <i class="fa fa-id-card-o"></i> </a></b></font></center>
        </div>
