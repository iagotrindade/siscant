...
$_SESSION['selecao'] = 1034;
$_SESSION['12_regiao'] = true;

$_SESSION['apresentacao_candidato'] = "Seleção TESTE ";
$_SESSION['nome_arquivo'] = "12rm_teste_2023.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos à Temporários<br> SELEÇÃO 2023<br>TESTES</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
