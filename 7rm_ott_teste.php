...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        <img src="sistema/imagens/7rm.png" width="80px">
        <center>
        <font color="white">
            <b> Sistema de Seleção de Candidatos Temporários
            <br> Oficias e Sargentos Técnicos Temporários
            <br> OTT/STT  2023
            </b>
        </font>
        </center>
      ...
      <div class="login-box">
          ...
          <form class="login-form" method="post" action="banco_dados/login.php" onsubmit="return verifica_campos()">
            <center>
                <font color='red' size="5px"><b>TESTE </b></font>
