...
$_SESSION['selecao'] = 1028;
$_SESSION['12_regiao'] = true;

$_SESSION['apresentacao_candidato'] = "Seleção OTT 2023";
$_SESSION['nome_arquivo'] = "12rm_ott_2023.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos à Temporários<br> SELEÇÃO 2023<br>OTT <br>(Oficial Técnico Temporário)</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
