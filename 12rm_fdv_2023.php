...
$_SESSION['selecao'] = 1030;
$_SESSION['mfdv'] = 1;
$_SESSION['apresentacao_candidato'] = "Seleção Farmacêuticos, Dentistas e Veterinários 2023";
$_SESSION['12_regiao'] = true;

$_SESSION['nome_arquivo'] = "12rm_fdv_2023.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2023<br>Farmacêuticos, Dentistas e Veterinários</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
          ...
          <form class="login-form" method="post" action="banco_dados/login.php" onsubmit="return verifica_campos()">
            <center><font size="5px"><b>SiSCanT </b></font><font size="2px"><b> Médicos</b></font></center>
        ...
        <p class="semibold-text mb-0"><a target="_blank" href="http://www.3rm.eb.mil.br/index.php?option=com_content&view=article&id=121"><u>Página do Processo Seletivo (Aviso de Convocação)</u></a></p>
        -->
    </section>
