...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2024<br>Músico CET (Cabos Especialistas Temporários)</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
          ...
          <form class="login-form" method="post" action="banco_dados/login.php" onsubmit="return verifica_campos()">
            <center><font size="5px"><b>SiSCanT </b></font><font size="2px"><b> CET</b></font></center>
