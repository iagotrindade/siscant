...
$_SESSION['nome_arquivo'] = "3rm_cet_santa_maria_2023.php";
$_SESSION['selecao'] = 1039;
$_SESSION['apresentacao_candidato'] = "Seleção CET SANTA MARIA 2023";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2023<br>CET (Cabos Especialistas Temporários)</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
