...
$_SESSION['selecao'] = 1005;
$_SESSION['mfdv'] = 1;
$_SESSION['apresentacao_candidato'] = "Seleção MÉDICOS 2023";
$_SESSION['12_regiao'] = true;

$_SESSION['nome_arquivo'] = "12rm_medicos_1_2023.php";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2023<br>MÉDICOS</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
