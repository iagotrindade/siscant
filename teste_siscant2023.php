...
//$_SESSION['pasta_arquivos'] = "/mnt/pdf/";

//AMBIENTE DE PRODUÇÃO 2023
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos Temporários<br> TESTES<br>SELEÇÃO DE TESTES</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
