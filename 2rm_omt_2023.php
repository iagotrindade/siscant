...
$_SESSION['nome_arquivo'] = "2rm_omt_2023.php";
// A seleção é referente ao index da tabela do banco de dados SELEÇÃO
$_SESSION['selecao'] = 1043;
$_SESSION['mfdv'] = 1;

$_SESSION['apresentacao_candidato'] = "Oficial Médico Temporário 2023 (OMT)";
