...
$rand = rand(100, 10000);
$string = "selecao_cet_motorista_2025";
$codigo_criptografar = $rand.time().$string;
$codigo_chave = substr(md5( $codigo_criptografar) ,0,6);
$_SESSION['chave'] = $codigo_chave;
    
$_SESSION['nome_arquivo'] = "8rm_cet_motorista_2025.php";

// A seleção é referente ao index da tabela do banco de dados SELEÇÃO
$_SESSION['selecao'] = 1142;
$_SESSION['8_regiao'] = true;

$_SESSION['apresentacao_candidato'] = "Seleção CET MOTORISTA 2025";
...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos Temporários<br> SELEÇÃO 2025<br>CET (Cabos Especialistas Temporários) Motorista C e D</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
