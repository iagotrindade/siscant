...
{
    erro("Erro 156444! Você não tem permissão!");
    exit();
}
...
$resultado = $conexao->restaura_curriculo($id_curriculo,$nome_curriculo);
$alteracoes_detalhadas =  print_r($resultado, true);

if($resultado)
    $insere_log = $conexao->insere_log($_SESSION['id_usuario'], $cpf, $id_curriculo, "17103", "curriculo", "Restaura", "Restaurou o currículo: $nome_curriculo", $alteracoes_detalhadas);
