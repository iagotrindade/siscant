...
$etapa_atual = (int)$_POST['etapa_atual'];
...
$etapa = 0;
$etapa = (int)$_POST['etapa_especialidade'];

if($_POST['etapa_especialidade'] == '' || $_POST['etapa_especialidade'] == null || $etapa == 0)
{
...
{
    erro("Erro 3456365! O candidato deve estar concorrendo no processo seletivo para mudar a especialidade dele de etapa!");
    exit();
}
...
if($resultado)
    $insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], "$id_usuario", "161509", "usuario", "Update", "Alterou a etapa da especialidade " . $nome_especialidade . " do candidado $candidato_cpf de ETAPA: $etapa_atual para ETAPA: $etapa", "$alteracoes_detalhadas");
else
{
    $conexao = null;
