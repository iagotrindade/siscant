...
$verifica_candidato_especialidade = $conexao->verifica_especialidade_candidato_eipot($_SESSION['id_usuario'], );
if(count($verifica_candidato_especialidade) > 0)

{
    erro("Erro 4856! Você já está cadastrado(a) em uma Arma");
    exit();
}  
...
if($_POST)
    $resultado = $conexao->insere_especialidade_candidato_eipot($_SESSION['id_usuario'],$id_especialidade);
...
header ("Location: ../sistema/candidato_especialidade_visualiza_eipot.php#fim_pagina");
