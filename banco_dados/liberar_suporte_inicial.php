...
$liberacao_suporte_inicial = (int)$get_selecao[0]['liberacao_suporte_inicial'];

if($liberacao_suporte_inicial == 1 && isset($_POST['liberacao']))
{
    erro("Erro 234643646! Status não alterado"); 
    exit();
}
if($liberacao_suporte_inicial == 0 && !isset($_POST['liberacao']))
{
...
$alteracao = "";
if($liberacao_suporte_inicial && !isset($_POST['liberacao']))
    $alteracao = "liberado para NÃO LIBERADO";
if(!$liberacao_suporte_inicial && isset($_POST['liberacao']))
    $alteracao = "não liberado para LIBERADO";

$resultado = $conexao->libera_suporte_inicial($libera);
