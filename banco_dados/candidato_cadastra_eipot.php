...
*/
    ...
    if($_POST['rm_inscricao'] != "")
        $rm_inscricao = htmlspecialchars(trim($_POST['rm_inscricao']));
    if($_POST['rm_destino_valores'] != "")
        $rm_destino = isset($_POST['rm_destino_valores']) ? $_POST['rm_destino_valores'] : '';
    ...
    if(trim($_POST['rm_inscricao']) == null || ($_POST['rm_inscricao']) == "")
    {
        erro_mensagem("Erro 9873216969455! A RM de Inscrição é obrigatória!");
        exit();
    }

    if(trim($_POST['rm_destino_valores']) == null || ($_POST['rm_destino_valores']) == "")
    {
        erro_mensagem("Erro 9873216969455! A RM de Interesse é obrigatória!");
        exit();
    }
    ...
    */
    ...
    if($_POST)
        $resultado = $conexao->insere_candidato_eipot(
                                                $senha_hash,
                                                $nome_completo,
                                                $cpf ,
                                                $identidade ,
    ...
    erro_mensagem("Erro 99966565456! Candidato não cadastrado!");
    exit();
    $conexao = null;
