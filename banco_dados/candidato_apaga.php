...
{
    erro("Candidato já está apagado!");
    exit();
}

if($candidato_apagado == 0)
{
    $resultado = $conexao->apaga_candidato($id_candidato,$cpf_candidato);
    $alteracoes_detalhadas =  print_r($resultado, true);
    if($resultado)
        $insere_log = $conexao->insere_log($_SESSION['id_usuario'], $cpf, $id_candidato, "15109", "usuario", "Delete", "Apagou o candidato: $cpf_candidato", $alteracoes_detalhadas);
