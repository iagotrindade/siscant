...
$resultado_teorico_pratica = $_POST['resultado_teorico_pratica'];
...
$resultado = $conexao->adiciona_resultado_teorico_pratico($id_candidato_x_especialidade, $resultado_teorico_pratica);

$alteracoes_detalhadas =  print_r($resultado, true);

if ($resultado)
    $insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], "$id_usuario", "161504", "candidato_x_especialidade", "Update", "Adicionou nota para prova teórico prática $resultado_teorico_pratica especialização $nome_especialidade do candidato: " . $cpf_candidato, "$alteracoes_detalhadas");
else {
    $conexao = null;
    //erro("Erro 4545736!");
    exit();
