...
if($id_usuario == "" || $id_usuario == null || $novo_email == "" || $novo_email == null || $admin_password == "" || $admin_password == null)
{
    erro("Erro 64263!");
    exit();
}
...
if($_POST)
    ...
    $resultado = $conexao->altera_email_candidato($id_usuario, $novo_email, $id_admin, $admin_password);

$alteracoes_detalhadas =  print_r($resultado, true);

if($resultado)
    $insere_log = $conexao->insere_log($_SESSION['id_usuario'], $_SESSION['cpf'], "$id_usuario", "161508", "candidato", "Update", "Alterou o email do candidato ".$get_candidato[0]['cpf']." para ".$novo_email, "$alteracoes_detalhadas");
else
{
    $conexao = null;
