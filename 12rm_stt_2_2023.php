...
function verifica_campos()
{
  ...
  <body>
    ...
    <section class="login-content">
        ...
        <center>
        <font color="white"><b>Sistema de Seleção de Candidatos à Temporários<br> SELEÇÃO 2023<br>STT <br>(Sargento Técnico Temporário)</b></font>
        </center>
      <div class="logo">
      </div>
      <div class="login-box">
